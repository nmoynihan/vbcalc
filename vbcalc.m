...
(*]*)
(*CalcLorentz[metric_, vb1_, vb2_, as_] :=*)
(*Module[{i,k,m},*)
...
(*If [check=== eta \[And]  dt ===1 \[Or] dt === -1, Print["This looks like a valid Lorentz Transformation"], Print["This does not look like a valid Lorentz Transformation"]];*)
(*L2*)
(*]*)
(**)
